...
const Memuitem = () => {
    const _menu = [
        { id: '1', name: '项目管理', path: '/project', per: 100, icon: MailOutlined },
        { id: '2', name: '配置包下载', path: '/package', per: 200 },
        { id: '3', name: '激活码管理', path: '/code', per: 220 },
        {
            id: '4', name: '数据管理', per: 300, children: [
                { id: '41', name: '终端统计', path: '/statisticsTerminal', per: 310 },
                { id: '42', name: '项目统计', path: '/statisticsProject', per: 320 },
            ]
        },
        { id: '5', name: '日志管理', path: '/logManager', per: 400 },
        {
            id: '6', name: '系统管理', per: 800, children: [
